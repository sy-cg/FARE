...
CONFIG="${CONFIG:-configs/fare_3090_gru1.yaml}"
...
for dataset in "${DATASETS[@]}"; do
  ...
  RUN_ID="fare_exposure_fairfirst_gru1_${dataset}_${BACKBONE}_${group_tag}_g${gamma_tag}_k${EXPOSURE_K}_${EXPOSURE_TARGET}_${clip_tag}_v1"
...
echo "========== FARE Exposure GRU4Rec GRU1 fixed finished =========="
